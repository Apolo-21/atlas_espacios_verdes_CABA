########################################################
# Obtención de las áreas naturales de Argentina de OSM #
########################################################

# Descargamos el extracto de Open Street Map (OSM) de áreas naturales de Argentina
#  desde geofrabrik.de (https://www.geofabrik.de/)
...
# un repositorio colaboraritvo para la construcción de mapas de uso libre. Ello 
# implica que los archivos disponibles se encuentran en constante transformación.
# Por este motivo, y debido a las diferentes instancias mecánicas que comprenden
# este trabajo, es posible que, al correr este script, algunos de los datos desarrollados
# en otras etapas del mismo queden desactualizados. 

# Aclaración: Los datos fueron descargados por última vez el 1 de febrero de 2022.
