#########################################################################
# Obtención de las estadísticas de delitos de la Ciudad de Buenos Aires #
#########################################################################
...
# ACLARACIóN: Al 24 de febrero de 2022, los últimos datos de delito disponibles
# para la Ciudad en el portal de datos abiertos del gobierno distrital corresponden
# al año 2020.
