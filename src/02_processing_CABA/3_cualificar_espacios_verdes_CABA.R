...
################################################################################################
# Ponderación de la superficie de espacios verdes de acuerdo con su condición de accesibilidad #
################################################################################################

# Los espacios verdes (EV) enrejados de la ciudad de Buenos Aires (CABA) abren sus
# puertas, generalmente, entre 08:00 hs y 20:00 hs. Como consecuencia, solo es posible 
# acceder a los mismos entre dichas horas. En base a esta situación, optamos por
# subponderar la superficie de los mismos con el fin de que nuestro indice de accesebilidad 
# a EV de cuenta de esta restricción temporal a la que se ven sujetos los vecinos
# y vecinas de la Ciudad.

# Abrimos nuestro dataset con los espacios verdes de la Ciudad de Buenos Aires.
...
# a los mismos puede ser penalizada a un 33%  de la superficie total del espacio cerrable.
ponderador <- 0.67
