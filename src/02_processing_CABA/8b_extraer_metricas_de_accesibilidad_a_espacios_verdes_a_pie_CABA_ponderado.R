########################################################
# Extraer métricas de accesibilidad a espacios verdes, caminando ponderadas por inseguridad
########################################################
...
espacios_verdes_cualificado <- st_read("data/processed/GCABA/EV/espacios-verdes-CABA-cualificados.shp") %>% 
    st_transform(4326)
