...
#########################################################################################
#Ponderar la superficie de los espacios públcos de acuerdo a si están abiertos o cerrados
#########################################################################################
...
# Los espacios enrejados de la ciudad cierran sus puertas entre 07:00 hs y 19:00 hs.

# Como consecuencia, no es posible acceder a ellos entre dichas.

# En base a esta situación, optamos por subponderar la superficie de los mismos con el fin de que nuestro indice de accesebilidad a EV de cuenta de esta restricción temporal.

# ¿Cómo subponderamos la superficie de los espacios verdes cerrables?
...
# En este caso, vamos establecer una penalización del 30% de la superficie.
ponderador <- 0.7
